...
export function AbiContract({ theme }) {
  ...
  return (
    <div style={{ maxWidth: 843, margin: '-32px auto 32px auto', background: theme.bg, borderRadius: 12, boxShadow: theme.shadow, padding: '28px 32px', textAlign: 'left', fontFamily: 'Inter, Arial, sans-serif', fontWeight: 500, fontSize: '1.08em', color: theme.primary, opacity: show ? 1 : 0, transform: show ? 'translateY(0)' : 'translateY(0)', transition: 'opacity 0.6s, transform 0.6s' }}>
      <p style={{ color: theme.primary, fontWeight: 400, fontSize: '1em', lineHeight: '1.6' }}>
...
export function HomeContract({ theme }) {
  ...
  React.useEffect(() => { const t = setTimeout(() => setShow(true), 500); return () => clearTimeout(t); }, []);
  return (
    <div style={{ maxWidth: 540, margin: '-32px auto 32px auto', background: theme.bg, borderRadius: 12, boxShadow: theme.shadow, padding: '28px 32px', textAlign: 'center', fontFamily: 'Inter, Arial, sans-serif', fontWeight: 500, fontSize: '1.12em', letterSpacing: '0.01em', opacity: show ? 1 : 0, transform: show ? 'translateY(0)' : 'translateY(0)', transition: 'opacity 0.6s, transform 0.6s' }}>
      <span style={{ color: theme.primary, fontWeight: 700 }}>
        <span style={{ fontSize: '1.08em', fontWeight: 700, display: 'block', marginBottom: '32px', color: theme.primary }}>
...
export function HowItWorksContract({ theme }) {
  ...
  return (
    <div style={{ maxWidth: 843, margin: '-32px auto 32px auto', background: theme.bg, borderRadius: 12, boxShadow: theme.shadow, padding: '28px 32px', textAlign: 'left', fontFamily: 'Inter, Arial, sans-serif', fontWeight: 500, fontSize: '1.08em', color: theme.primary, opacity: show ? 1 : 0, transform: show ? 'translateY(0)' : 'translateY(0)', transition: 'opacity 0.6s, transform 0.6s' }}>
      <h2 style={{ color: theme.primary, fontWeight: 700, fontSize: '1.3em', margin: 0, marginBottom: '18px' }}>How It Works</h2>
      <p style={{ color: theme.primary, fontWeight: 400, fontSize: '1em', lineHeight: '1.6' }}>
...
export function MyDeploymentsContract({ theme }) {
  ...
  return (
    <div style={{ maxWidth: 843, margin: '-32px auto 32px auto', background: theme.bg, borderRadius: 12, boxShadow: theme.shadow, padding: '28px 32px', textAlign: 'left', fontFamily: 'Inter, Arial, sans-serif', fontWeight: 500, fontSize: '1.08em', color: theme.primary, opacity: show ? 1 : 0, transform: show ? 'translateY(0)' : 'translateY(0)', transition: 'opacity 0.6s, transform 0.6s' }}>
      <h2 style={{ color: theme.primary, fontWeight: 700, fontSize: '1.3em', margin: 0, marginBottom: '18px' }}>My Deployments</h2>
      <p style={{ color: theme.primary, fontWeight: 400, fontSize: '1em', lineHeight: '1.6' }}>
...
export function ClickCounterContract({ isWalletConnected, connectWallet, setPopup, theme }) {
  ...
  React.useEffect(() => { const t = setTimeout(() => setShow(true), 500); return () => clearTimeout(t); }, []);
  return (
    <div style={{ maxWidth: 843, margin: '-32px auto 32px auto', background: '#e9eaec', borderRadius: 12, boxShadow: '0 2px 12px rgba(0,0,0,0.04)', padding: '28px 32px', textAlign: 'left', fontFamily: 'Inter, Arial, sans-serif', fontWeight: 500, fontSize: '1.08em', color: '#2563eb', opacity: show ? 1 : 0, transform: show ? 'translateY(0)' : 'translateY(0)', transition: 'opacity 0.6s, transform 0.6s' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '18px' }}>
