    ...
    >
      <p style={{ marginBottom: 24 }}>
        ...
        <div style={{ marginBottom: 32 }}>
          <div style={{ marginTop: '8px', borderRadius: '10px', background: theme.codeBg, boxShadow: '0 2px 12px rgba(0,0,0,0.06)', position: 'relative', overflow: 'hidden', border: '1.5px solid #2a3244' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', background: theme.codeBg, padding: '8px 18px 8px 18px', borderTopLeftRadius: '10px', borderTopRightRadius: '10px', borderBottom: '1.5px solid #2a3244' }}>
